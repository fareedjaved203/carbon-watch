...
const Footer = () => {
  return (
    <div className="bg-black flex justify-center items-center pt-16 pb-20 px-4 md:px-16">
      <div className="space-y-12">
        ...
        >
          ...
          <div className="hover:underline cursor-pointer">Email Marketing</div>
          <div className="hover:underline cursor-pointer">Branding</div>
          <div className="hover:underline cursor-pointer">Offline</div>
