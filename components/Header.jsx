...
const Header = () => {
  return (
    <div className="container mx-auto flex justify-center items-center w-full px-4 md:px-10 py-2 md:py-1">
      <div className="bg-gradient-to-r from-[#f4f4f4] to-[#DEDBD6] w-full flex justify-center items-center flex-col flex-col-reverse md:flex-row rounded-xl">
        <div className="flex-1 md:px-10 flex space-y-10 flex-col w-full p-2 py-4">
          <div className="clash-display text-4xl md:text-6xl space-y-4 w-full">
            <div className="flex space-x-2">
              <div className="z-10">Grab </div>
              <div
                className="font-promptFont pl-4 text-center bg-white rounded-xl w-[37%] text-[#1E392B] shadow-lg transform -rotate-3 -translate-x-[20%]"
