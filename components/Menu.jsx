...
const Menu = () => {
  return (
    <>
      <header
        class="hidden md:block text-black font-inter"
        style={{ fontSize: "13px", fontWeight: "500" }}
      >
        <div class="flex flex-wrap flex-col p-5 px-20 md:flex-row items-center">
          ...
          <button className="bg-black text-[#D9D9D9] text-center rounded-full px-10 py-3">
            Sign in
          </button>
        </div>
      </header>
