    ...
    <div className="container mx-auto px-4 md:px-16 my-20">
      <div className="px-4 flex flex-col flex-col-reverse md:flex-row justify-between bg-black rounded-xl">
        <div className="p-4 flex justify-between flex-col space-y-8 md:space-y-0">
          <div className="space-y-2 md:space-y-3 mt-4 md:mt-4">
            <div
              className="inline-block bg-[#FF0000] p-1 px-4 rounded-md text-white"
              style={{ fontSize: "15.57px", lineHeight: "19.57px" }}
            >
              Sale
            </div>
            <div className="clash-display text-3xl md:text-5xl text-white">
              SMART WEARABLE.
            </div>
            <div className="clash-display-regular text-xl md:text-2xl text-white">
              UP to 80% OFF
            </div>
          </div>
          <div>
